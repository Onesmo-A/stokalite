...
import CameraBarcodeScannerModal from "../../shared/CameraBarcodeScannerModal";
    ...
    return (
        <Col className="position-relative my-3 search-bar col-xxl-8 col-lg-12 col-12">
            <CameraBarcodeScannerModal
                ...
                title={getFormattedMessage("pos-globally.search.field.label")}
            />
